    ...
    for n_element in element_list:
        ...
        if isotopes_list==None:
            for i,(nt_kg,mn) in enumerate(zip(element.nt_kg,element.mass)): 
                ##print(nt_kg)
                ##print(vmin)
                ##print(dsigma_der(element,hamiltonian,mchi,vmin,er,j_chi,delta,n_vel_list=n_vel_list,**args))               
...
element_list=[Al,Ar,C,Cr,F,Fe,Ge,H,He,I,Li,Mg,N,Na,Ne,Ni,O,P,S,Si,Xe] 

element_obj_names_string='WD.Al WD.Ar WD.C  WD.Cr WD.F WD.Fe WD.Ge WD.H WD.He WD.I WD.Li WD.Mg WD.N WD.Na WD.Ne WD.Ni WD.O WD.P WD.S WD.Si WD.Xe' 
